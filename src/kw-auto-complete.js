...
(function(KW) {
	...
	/* test-code */
 	KW.__testonly__ = {
		setupInputElement: setupInputElement,
		setupDefaultInputElement: setupDefaultInputElement,
		createAutoCompleteElement: createAutoCompleteElement,
		createParentElement: createParentElement,
		updateUI: updateUI
